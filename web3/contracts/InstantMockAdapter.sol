...
/// @title InstantMockAdapter
/// @notice Mock adapter that returns funds instantly (no queue, no callback)
/// @dev For testing only - bypasses unbonding completely
...
contract InstantMockAdapter is IStakingAdapterBNB {
    ...
    /// @notice Mock harvest - provides small rewards for testing
